...
public class SoftKeyboard extends InputMethodService
    ...
    private StringBuilder mComposed = new StringBuilder();
    ...
    public void handleVoiceInput(){
        ...
        //Log.d("VOICEINPUT2", voiceinput.recordedText);
    ...
    private void storeText(InputConnection currentInputConnection) {
        if (mComposed.length() > 0)
        {
            ...
            Log.d("Socialite2", before.toString());
            Log.d("Socialite3", after.toString());
            String finText = before.toString().trim() + " " + after.toString().trim();
            Log.d("Socialite4", finText);
        }
    }
